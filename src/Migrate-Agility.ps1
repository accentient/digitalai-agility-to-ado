...
function Main
{
  ...
  # Migrate -DryRun -IncludeClosed -Types Task -Scope "Scope:3456"  # Task has NEVER been dry run
  # Migrate -DryRun -IncludeClosed -Types Story,Defect,Issue -Scope "Scope:3456"  # one scope
  ...
  # Migrate -DryRun -IncludeClosed -Scope "Scope:5678"             # the EDU scope (Scope:5678), 466 items
  # Migrate -DryRun -IncludeClosed -Scope "Scope:5678"
