...
# with a closer name someone ADO will not accept (Morgan West alone closed 311), and those items
...
#
# Used ONLY when an item would otherwise land at the project root. One scope (Scope:1234, the
...
# here, because a customized process renames them: the client's Product Backlog Item and Bug have a custom
